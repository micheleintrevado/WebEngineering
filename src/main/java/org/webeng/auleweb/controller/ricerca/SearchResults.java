 ...
 * @author enric
 */
public class SearchResults extends AulewebBaseController {
    ...
    /**
     * Gestisce i risultati per gli utenti. Se viene passato un id di un utente,
     * viene visualizzata la pagina di dettaglio dell'utente. Altrimenti viene
     * visualizzata la lista degli utenti corrispondenti alla keyword.
     *
    ...
    /**
     * Gestisce i risultati per gli collezioni. Se viene passato un id di un
     * collezione, viene visualizzata la pagina di dettaglio dell'collezione.
     * Altrimenti viene visualizzata la lista degli collezioni corrispondenti
     * alla keyword.
     *
     * @param request servlet request
     * @param response servlet response
    ...
    /**
     * Gestisce i risultati per i dischi. Se viene passato un id di un disco,
     * viene visualizzata la pagina di dettaglio del disco. Altrimenti viene
     * visualizzata la lista dei dischi corrispondenti alla keyword.
     *
     * @param request servlet request
     * @param response servlet response
     */
    ...
    /**
     * Gestisce i risultati per le tracce. Se viene passato un id di una
     * traccia, viene visualizzata la pagina di dettaglio dela traccia.
     * Altrimenti viene visualizzata la lista delle tracce corrispondenti alla
     * keyword.
     *
     * @param request servlet request
     * @param response servlet response
    ...
    /**
     * Gestisce i risultati per gli autori. Se viene passato un id di un autore,
     * viene visualizzata la pagina di dettaglio dell'autore. Altrimenti viene
     * visualizzata la lista degli autori corrispondenti alla keyword.
     *
     * @param request servlet request
     * @param response servlet response
     */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (!type.isBlank()) {
            switch (type) {
                case ("UTENTI") ->
                    action_utente(request, response);
                case ("COLLEZIONI") ->
                    action_collezioni(request, response);
                case ("DISCHI") ->
                    action_disco(request, response);
                case ("TRACCE") ->
                    action_traccia(request, response);
                case ("AUTORI") ->
                    action_autori(request, response);
                default ->
