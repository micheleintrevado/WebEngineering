...
public class Filter extends AulewebBaseController {
    ...
    private void loadData(HttpServletRequest request, HttpServletResponse response) {
        try {
            ...
            LocalDate fineSettimanaLocalDate = inizioSettimana.toLocalDate().plusDays(7);
            Date fineSettimana = Date.valueOf(fineSettimanaLocalDate);
            ...
            request.setAttribute("fineSettimana", fineSettimana);
            request.setAttribute("gruppo", gruppo);
            
            List<Aula> auleGruppo = dataLayer.getAulaDAO().getAuleByGruppo(gruppo);
            if (request.getParameter("eventi_attuali") != null ||
                    request.getParameter("eventi_prossimi") != null || 
                    request.getParameter("aule_giorno") != null ||
                    (request.getParameter("id_aula") != null && (!request.getParameter("id_aula").equals("")) && inizioSettimana != null) ||
                    (request.getParameter("id_corso") != null && (!request.getParameter("id_corso").equals("")) && inizioSettimana != null)) {
                ...
                if (request.getParameter("id_aula") != null && (!request.getParameter("id_aula").equals("")) && inizioSettimana != null) {
                ...
                if (request.getParameter("id_corso") != null && (!request.getParameter("id_corso").equals("")) && inizioSettimana != null) {
